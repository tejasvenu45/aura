...
function AboutDomain({ title, content, img }) {
  return (
    <div className="bg-black text-green-500 rounded-lg p-6 border-4 border-orange-500 shadow-xl shadow-purple-700 hover:scale-105 hover:text-white">
      <Zoom>
      ...
      <p className="text-white hover:scale-105">{content}</p>
      </Zoom>
    </div>
  );
}
